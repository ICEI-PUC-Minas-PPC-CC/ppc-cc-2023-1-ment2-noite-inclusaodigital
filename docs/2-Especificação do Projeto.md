...
|**Camila Fiães**|           |                             | 
|-------------------|-----------|-----------------------------|
<img src="https://static8.depositphotos.com/1375799/888/i/600/depositphotos_8885558-stock-photo-70-year-old-woman-smiling.jpg" width="200" height="300"/>|**Idade:** 38 anos. **Naturalidade:** Contagem - Minas Gerais. **Ocupação:** Caixa de Supermercado.       |**Atribuições:** gerenciar operações com clientes usando caixas registradoras. 
